[![Run App <Schmidt>, <Matthew>](https://github.com/mschmidt15/GithubActions/actions/workflows/ci.yml/badge.svg)](https://github.com/mschmidt15/GithubActions/actions/workflows/ci.yml)
